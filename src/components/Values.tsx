  ...
  return (
    section className=section-padding bg-marble-ivory ref={ref}
      div className=container-narrow mx-auto
        div className=grid smgrid-cols-2 lggrid-cols-4 gap-8 lggap-6
          {values.map((value, i) = (
            motion.div
              key={value.number}
              ...
              { Top line }
              div className=h-[1px] bg-stone-300 mb-6 origin-left transition-transform duration-500 group-hoverscale-x-100 scale-x-50 
              
              span className=font-serif text-4xl text-stone-300 transition-colors duration-400 group-hovertext-graphite-dark
                {value.number}
              span

              h3 className=font-sans text-sm font-medium tracking-wide mt-4 mb-3 text-graphite-dark transition-transform duration-400 group-hovertranslate-x-1
                {value.title}
              h3
